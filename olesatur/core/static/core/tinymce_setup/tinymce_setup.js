...
tinyMCE.init({
    ...
    theme_advanced_buttons1: 'formatselect,fontselect,fontsizeselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,grappelli_adv',
