...
tinyMCE.init({
    ...
    //mode: 'textareas',
    mode: "exact",
    elements: tinymce_elements || "id_content",
    theme: 'advanced',
    skin: 'grappelli',
    ...
    theme_advanced_buttons1: 'bold,italic,underline,|,formatselect,fontselect,fontsizeselect,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,blockquote,|,fullscreen,|,grappelli_adv',
    theme_advanced_buttons2: 'undo,redo,|,link,unlink,|,image,|,search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,grappelli_documentstructure',
