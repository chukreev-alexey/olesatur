...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Direction.content'
        db.alter_column(u'website_direction', 'content', self.gf('tinymce.models.HTMLField')(null=True))
        # Adding field 'Banner.visible'
        db.add_column(u'website_banner', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BgImage.visible'
        db.add_column(u'website_bgimage', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Direction.content'
        db.alter_column(u'website_direction', 'content', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'Banner.visible'
        db.delete_column(u'website_banner', 'visible')

        # Deleting field 'BgImage.visible'
        db.delete_column(u'website_bgimage', 'visible')
