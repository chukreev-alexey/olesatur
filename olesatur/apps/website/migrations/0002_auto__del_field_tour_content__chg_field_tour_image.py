...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tour.content'
        db.delete_column(u'website_tour', 'content')


        # Changing field 'Tour.image'
        db.alter_column(u'website_tour', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True))

    def backwards(self, orm):
        # Adding field 'Tour.content'
        db.add_column(u'website_tour', 'content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Tour.image'
        db.alter_column(u'website_tour', 'image', self.gf('filebrowser.fields.FileBrowseField')(default='', max_length=200))
