...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfoBlock.html_content'
        db.add_column('pages_infoblock', 'html_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfoBlock.html_content'
        db.delete_column('pages_infoblock', 'html_content')
